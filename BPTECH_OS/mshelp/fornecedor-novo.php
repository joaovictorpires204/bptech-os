        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
            <fieldset>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="nome">Nome do fornecedor</label>
                    <div class="col-md-8">
                ...
                if(isset($_POST['enviar']) && $_POST['enviar'] == 'Adicionar'){
                    ...
                    $sql1 = $conn->query("INSERT INTO `fornecedores`(`fornecedor`, `email1`, `usuario`, `senha`, `cadastrado_por`) VALUES ('".$nome."','".$email."','".$login."','".$senha."','".$idusuario."');") or die ( mysqli_error($conn));
