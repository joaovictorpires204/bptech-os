        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="chamado">
                ...
                <div class="col-md-12 text-left">
                        <button id="voltar" name="voltar" class="btn btn-secondary text-left" value="Voltar">VOLTAR</button>
                </div>

                <div class="form-group">
                    <label class="col-md-8 control-label" for="enviar"></label>
                    <div class="col-md-12 text-center">
                        <button  name="fechar" class="btn btn-danger" value="fechar">FECHAR CHAMADO</button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-md-8 control-label" for="enviar"></label>
                    <div class="col-md-12 text-center">
                        <button id="enviar" name="enviar" class="btn btn-primary" value="responder">RESPONDER</button>
                    </div>
                </div>
                ...
                <?php if($row['status'] != '4' && $row['status'] != '6' && $tipoacesso != '1' ){ ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-12 text-center">
                                <button  name="fechar" class="btn btn-danger" value="cancelar">CANCELAR CHAMADO</button>
                            </div>
                        </div>
                ...
                <?php } else if($row['status'] === '4' || $row['status'] === '6' ){ ?>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="enviar"></label>
                            <div class="col-md-12 text-center">
                                <button  name="fechar" class="btn btn-success" value="reabrir">REABRIR CHAMADO</button>
                            </div>
                        </div>
