...
<div class="">
        ...
        <div class="chamado">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        Setor
                        <select name="s" class="form-control" required id="cod_setor_col">
                    ...
                    <div class="col-md-4 <?php echo $esconder;?>">
                        Colaborador
                        <select name="c" class="form-control" required id="cod_colab">
                            <option value="0">Todos</option>
                            <?php
    ...
    <a id="enviar" href="chamado-novo.php" class="btn btn-primary btn-block">ABRIR CHAMADO</a>
